...
namespace WindowsFormsApp7
{
    public partial class Form2 : Form
    {
        ...
        private void btn_cal_Click(object sender, EventArgs e)
        {
            ...
            double mathTotal = 0;
            double[] englishArr = new double[listBox1.Items.Count];
            double[] chinesshArr = new double[listBox1.Items.Count];
            double[] mathArr = new double[listBox1.Items.Count];
            ...
            double englishAvg = Math.Round(englishTotal / listBox1.Items.Count, 2, MidpointRounding.AwayFromZero); ;
            //MessageBox.Show(listBox1.Items.Count.ToString());
            double chinessAvg = Math.Round(chinessTotal / listBox1.Items.Count, 2, MidpointRounding.AwayFromZero); ;
            double mathAvg = Math.Round(mathTotal / listBox1.Items.Count, 2, MidpointRounding.AwayFromZero); ;
            ...
            lab_calAll.Text = $"總分: {englishTotal}   {chinessTotal}   {mathTotal}" +
                ...
                $"\n最高分: {englishArr[listBox1.Items.Count - 1]}   {chinesshArr[listBox1.Items.Count - 1]}   {mathArr[listBox1.Items.Count - 1]}" +
        ...
        int chinessScore_rangeMin;
        int chinessScore_rangeMax;

        private void btn_search_Click(object sender, EventArgs e)
        {
            
            chinessScore_rangeMin =int.Parse( txt_rangemin.Text);
            chinessScore_rangeMax = int.Parse(txt_rangemax.Text);
            int removeCount = listBox1.Items.Count-1;
            //MessageBox.Show(removeCount.ToString());

            
            for (int i= removeCount; i>=0; i--)
            {
                MessageBox.Show(i.ToString());
                if (((stcScore)lstScore[i]).chinessScore < chinessScore_rangeMin || ((stcScore)lstScore[i]).chinessScore > chinessScore_rangeMax)
                {
                    //MessageBox.Show(chinessScore_rangeMin.ToString()+"  " + chinessScore_rangeMax.ToString());
                    MessageBox.Show(((stcScore)lstScore[i]).chinessScore.ToString());
                    //MessageBox.Show(listBox1.Items.Count.ToString());
                    //MessageBox.Show(i.ToString());
        ...
        private void btn_insert_Click(object sender, EventArgs e)
        {
            ...
            if (scoreArr[0] == Score.chinessScore)
            {
                if (scoreArr[2] == Score.englishScore)
                {
                    listBox1.Items.Insert(0, "   " + Score.studentName + "         " + Score.chinessScore + "         "
                        + Score.englishScore
                + "        " + Score.mathScore + "          " + Score.totalScore + "         " + avgScore2
                + "  英文" + Score.englishScore + "  國文" + Score.chinessScore);
                }
